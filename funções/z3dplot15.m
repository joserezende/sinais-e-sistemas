function z3dplot15(b,a)
% Plota em 3D a Transformada Z racional B(z)/A(z) e B(z=exp(jw))/A(z=exp(jw)) , w de 0 a pi
% -----------------------------------------------------------------------------------------
%       z3dplot(b,a)
%
...
zmax=15*max(max(abs(ze2)),max(abs(po2))) 
if(zmax<15) zmax=15; end
